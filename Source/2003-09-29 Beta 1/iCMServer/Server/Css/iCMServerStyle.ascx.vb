...
#End Region
    ...
    Private Sub Render_Stylecheet()
        ...
        Content += "A:link {text-decoration:	none;color:	#3333cc;}" & vbCrLf
        Content += "A:visited {text-decoration:	none;color:	#333399;}" & vbCrLf
        Content += "A:active {text-decoration:	none;color:	#333399;}" & vbCrLf
        Content += "A:hover {text-decoration:	underline;color:	#3333cc;}" & vbCrLf
