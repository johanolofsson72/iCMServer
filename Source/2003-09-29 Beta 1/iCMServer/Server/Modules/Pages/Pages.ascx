...
<TABLE cellSpacing="1" cellPadding="1" border="0" id="Table1" align="left">
	<tr valign="top">
		...
		<td width="50%" class="Normal" align="left">
			<table cellSpacing="0" cellPadding="0" border="0" id="Table2">
				<tr>
					<td class="SubSubHead" align="left"><%=oLang.Find(al, "pag_info")%> <input value="<%=oLang.Find(al, "pag_selpage")%>" class="SubSubHead" type="text" id="Sel" name="Sel" readonly size="23">
					</td>
				</tr>
			</table>
		</td>
		<td width="44%" class="Normal" align="left">
			<IMG id="imgUp" alt="<%=oLang.Find(al, "pag_moveup")%>" src="Server/Modules/Pages/images/MovePageUp.gif"
										onclick="MoveUpSubItem()" align="middle" style="CURSOR:hand">
			<IMG id="imgDown" alt="<%=oLang.Find(al, "pag_movedown")%>" src="Server/Modules/Pages/images/MovePageDown.gif"
										onclick="MoveDownSubItem()" align="middle" style="CURSOR:hand">
			<IMG id="imgRight" alt="<%=oLang.Find(al, "pag_moveto")%>" src="Server/Modules/Pages/images/MovePageRight.gif"
										onclick="MoveTo()" align="middle" style="CURSOR:hand">
		...
		<td width="5%" class="Normal" align="right" colspan="2">
			<table id="Table3">
				<tr height="10">
