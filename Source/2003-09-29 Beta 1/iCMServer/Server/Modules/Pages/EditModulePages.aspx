								...
								<td width="*">
									<table cellSpacing="1" cellPadding="2" border="0">
										...
										<tr>
											...
											<td colSpan="3">&nbsp;
												<asp:TextBox id="bColor" runat="server" Width="62px" Font-Name="verdana"></asp:TextBox><INPUT onclick="ChangeColor();" style="cursor:hand; WIDTH: 16px; HEIGHT: 22px" type="button" value="...">
											</td>
										</tr>
										<tr>
											<td>&nbsp;
										...
										<tr>
											...
											<td colSpan="3"><asp:checkboxlist id="authEditRoles" runat="server" width="300" RepeatColumns="2" Font-Names="Verdana,Arial"
													Font-Size="8pt" cellpadding="0" cellspacing="0"></asp:checkboxlist></td>
										</tr>
										<tr>
											<td colSpan="4">
												<hr noShade SIZE="1">
