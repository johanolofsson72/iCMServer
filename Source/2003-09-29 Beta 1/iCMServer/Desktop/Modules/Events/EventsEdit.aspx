<%@ Page Language="vb" AutoEventWireup="false" Codebehind="EventsEdit.aspx.vb" Inherits="iConsulting.iCMServer.Modules.Events.EventsEdit"%>
								...
								<td width="*">
									...
									<table cellSpacing="0" cellPadding="0" width="750">
										...
										<tr vAlign="top">
											...
											<td><asp:textbox id="txtShowDate" runat="server" Width="112px"></asp:textbox></td>
											<td class="Normal"></td>
										</tr>
										<tr vAlign="top">
