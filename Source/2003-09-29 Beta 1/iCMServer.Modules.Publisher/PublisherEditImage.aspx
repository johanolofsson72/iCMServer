							...
							<tr vAlign="top">
								...
								<td>
									<table cellSpacing="0" cellPadding="0" width="500">
										<tr>
											<td class="Head" align="left" style="HEIGHT: 18px">&nbsp;
												<asp:Label id="lblHeader" runat="server">lblHeader</asp:Label>
											</td>
											<td class="Head" align="right" style="HEIGHT: 18px">Max : 3000 Kb
											</td>
										</tr>
										<tr>
											<td colSpan="2">
									...
									<table border="0">
										<tr>
											<td align="left" width="200"><asp:button id="btnSave" runat="server" Text="Spara" CssClass="iCWebControlsII" Width="60"></asp:button>
												<asp:button id="btnCancel" runat="server" Text="Ångra" CssClass="iCWebControlsII" Width="60"></asp:button></td>
										</tr>
										<tr>
											<td colSpan="2">
