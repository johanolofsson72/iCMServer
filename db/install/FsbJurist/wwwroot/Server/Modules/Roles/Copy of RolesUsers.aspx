							...
							<tr vAlign="top">
								...
								<td width="*">
									<table cellSpacing="1" cellPadding="2" border="0">
											...
											<td colSpan="3">
												<asp:DataList id="userRoles" RepeatColumns="3" DataKeyField="usr_id" runat="server">
													...
													<ItemTemplate>
														...
														<asp:Label Text='<%# DataBinder.Eval(Container.DataItem, "usr_firstname")%>&nbsp;<%# DataBinder.Eval(Container.DataItem, "usr_firstname")%>' cssclass="SubSubHead" runat="server" ID="Label2" />
													</ItemTemplate>
												</asp:DataList>
											</td>
										</tr>
										...
										<tr>
											<td colSpan="4">
												<asp:Button id="btnOk" runat="server" Text="Button"></asp:Button></td>
										</tr>
									</table>
								</td>
							</tr>
