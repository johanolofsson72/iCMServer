ALTER TABLE `sit_sites` ADD `sit_sitewidth` varchar (10) ;
ALTER TABLE `sit_sites` ADD `sit_sitealign` varchar (10)  ;
ALTER TABLE `sit_sites` ADD `sit_containerwidth1` varchar (10)  ;
ALTER TABLE `sit_sites` ADD `sit_containerwidth2` varchar (10)  ;
ALTER TABLE `sit_sites` ADD `sit_containerwidth3` varchar (10)  ;
ALTER TABLE `sit_sites` ADD `sit_metadescription` text  ;
ALTER TABLE `sit_sites` ADD `sit_metakeywords` text  ;
ALTER TABLE `sit_sites` ADD `sit_metaauthor` varchar (100)  ;
ALTER TABLE `sit_sites` ADD `sit_metacopyright` varchar (100)  ;
ALTER TABLE `sit_sites` ADD `sit_metarobots` varchar (100) ;

 
UPDATE `sit_sites` SET`sit_sitewidth` = 'n/a';
UPDATE `sit_sites` SET`sit_sitealign` = 'left';
UPDATE `sit_sites` SET`sit_containerwidth1` = '170';
UPDATE `sit_sites` SET`sit_containerwidth2` = '600';
UPDATE `sit_sites` SET`sit_containerwidth3` = '170';
UPDATE `sit_sites` SET`sit_metadescription` = 'iConsulting iCMServer Pro';
UPDATE `sit_sites` SET`sit_metakeywords` = 'iConsulting,iCMServer';
UPDATE `sit_sites` SET`sit_metaauthor` = 'iConsulting';
UPDATE `sit_sites` SET`sit_metacopyright` = 'Copyright 2004 iConsulting';
UPDATE `sit_sites` SET`sit_metarobots` = 'index,follow';


-- men_menu --;

 
ALTER TABLE men_menu ADD men_multiplicator varchar (10)  ;
ALTER TABLE men_menu ADD men_headtextalign varchar (10)  ;
ALTER TABLE men_menu ADD men_subtextalign varchar (10)  ;
ALTER TABLE men_menu ADD men_headwidth varchar (10)  ;
ALTER TABLE men_menu ADD men_subwidth varchar (10)  ;
ALTER TABLE men_menu ADD men_headheight varchar (10)  ;
ALTER TABLE men_menu ADD men_subheight varchar (10) ;

 
UPDATE men_menu SET men_multiplicator = '9.5' ;
UPDATE men_menu SET men_headtextalign = 'left' ;
UPDATE men_menu SET men_subtextalign = 'left' ;
UPDATE men_menu SET men_headwidth = 'n/a' ;
UPDATE men_menu SET men_subwidth = 'n/a' ;
UPDATE men_menu SET men_headheight = '18' ;
UPDATE men_menu SET men_subheight = '18';
