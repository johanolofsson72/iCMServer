...
CREATE TABLE iCMServer.cat_catalogs
...
CREATE TABLE iCMServer.dis_discussion
...
CREATE TABLE iCMServer.doc_documents
...
CREATE TABLE iCMServer.eve_events
...
CREATE TABLE iCMServer.htm_htmltext
...
CREATE TABLE iCMServer.ifr_iframe
...
CREATE TABLE iCMServer.lgt_languagetext
...
CREATE TABLE iCMServer.lng_language
...
CREATE TABLE iCMServer.mde_moduledefinitions
...
CREATE TABLE iCMServer.men_menu
...
CREATE TABLE iCMServer.mod_modules
...
CREATE TABLE iCMServer.mse_modulesettings
...
CREATE TABLE iCMServer.pag_page
...
CREATE TABLE iCMServer.qui_quicklinks
...
CREATE TABLE iCMServer.rol_roles
...
CREATE TABLE iCMServer.sit_sites
...
CREATE TABLE iCMServer.slg_sitelog
...
CREATE TABLE iCMServer.uro_userroles
...
CREATE TABLE iCMServer.usr_users
...
CREATE TABLE iCMServer.ver_version
