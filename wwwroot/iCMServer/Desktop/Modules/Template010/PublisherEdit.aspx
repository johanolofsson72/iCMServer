...
<%@ Page Language="vb" validaterequest="false" autoeventwireup="false" codebehind="PublisherEdit.aspx.vb" Inherits="iConsulting.iCMServer.Modules.Template010.PublisherEdit" %>
<HTML>
	<HEAD>
	...
	<body onload="Initialize();" ms_positioning="GridLayout">
												...
												<td class="toolz" valign="middle" align="left">
													...
													<table>
														<tr>
															...
															<script>if(ShowSpecialCommand){document.write('<td><input id=ViewModeSelector onfocus=this.blur() onclick=ChangeContentViewMode() type=checkbox checked=checked /></td>');}</script>
		...
		<script>
			...
			{
				try{
					document.getElementById('ContentView').contentWindow.document.getElementById("liner001").focus(); 
				}
				catch(e)
				{
					alert(e);
			...
			try{
				document.Editor.DesignMode
				document.Editor.removeChild
				window.setTimeout("DefaultFocus()",400);
			}
			catch(e)
			{
				alert(e);
