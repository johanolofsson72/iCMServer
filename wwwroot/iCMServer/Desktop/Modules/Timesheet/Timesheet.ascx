<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Timesheet.ascx.vb" Inherits="iConsulting.iCMServer.Modules.Timesheet.Timesheet" targetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<%@ Register TagPrefix="Site" TagName="Title" Src="~/Desktop/Controls/DesktopModuleTitle.ascx"%>
<SITE:TITLE id="Title2" EditText="" Location="iConsulting.iCMServer.Modules.Calendar" Phrase="timesheet_edit" EditUrl="~/Desktop/Modules/Timesheet/TimesheetEdit.aspx" runat="server"></SITE:TITLE>
	...
	<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
		<tr height="20">
			...
			<TD vAlign="top" bgcolor="#ffffff" align="left" width="322" style="BORDER-TOP: black 1px solid; BORDER-LEFT: black 1px solid; WIDTH: 322px; BORDER-BOTTOM: black 1px solid">
				...
				<IMG onclick="OPENNEW<%=ModuleId%>('<%=ViewState.Item("iCMServer.Modules.Timesheet.SelectedDay" & ModuleId)%>');" id="imgA" alt="" src="Desktop/Modules/Timesheet/Images/newappointment.gif"
					style="CURSOR: hand">
				<%End If%>
